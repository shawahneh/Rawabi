...
import com.techcamp.aauj.rawabi.model.CustomBeans.FireJourney;
import com.techcamp.aauj.rawabi.model.CustomBeans.FireRide;
...
public class WebDummy implements CarpoolApi,AuthWebApi, BasicApi{
    ...
    public WebDummy(Context context){
    ...
    public static WebDummy getInstance() {
        return instance;
    }
